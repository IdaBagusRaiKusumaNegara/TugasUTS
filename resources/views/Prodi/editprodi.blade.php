...
@include('Template.navbar')
  ...
  <div class="content-wrapper">
    ...
    <!-- form start -->
    <div class="card-body">
      <form action="{{ url('updateprodi', $prd->id) }}" method="post">
      {{ csrf_field() }}
          <div class="form-group">
            <label >Nama Prodi</label>
            <input type="text" class="form-control" id="nama_prodi" name="nama_prodi" placeholder="Masukan Nama Prodi" value="{{ $prd->nama_prodi }}">
